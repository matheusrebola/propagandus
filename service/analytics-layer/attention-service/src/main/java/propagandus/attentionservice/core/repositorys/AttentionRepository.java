...
public interface AttentionRepository extends JpaRepository<Attention, Long> {
  ...
  List<AttentionLevelDTO> findHighestAttentionByPainelModel();
  ...
  Integer findTotalLooksForPainelInWeek(@Param("painelId") Long painelId);
  ...
  List<PainelAttentionDTO> findPainelsWithMostPeopleAtNight();
  ...
  List<AttentionLevelDTO> findHighestAttentionByState();
  ...
  List<PainelAttentionDTO> findInteractionCountByPainelAndMonth(@Param("month") EMonth month);
  ...
  List<PainelInteractionDTO> findPainelsWithMostInteractionsAtHour(@Param("hour") Byte hour);
  ...
  List<CityPeriodLookDTO> countLooksByCityAndPeriod();
  ...
  List<PainelAttentionDTO> findMostViewedPainelsByDate(@Param("date") LocalDateTime date);
  ...
  List<PainelAttentionStateDTO> findHighestAttentionLevelByPainelInState(@Param("state") String state);
  ...
  List<AverageAttentionDTO> findAverageLooksByPainelAtHour(@Param("hour") Byte hour);
  ...
  List<PainelInteractionDTO> findPainelsWithMostInteractionsByDayOfWeek(@Param("dayWeek") EDayWeek dayWeek);
