...
/*
  ...
  List<PainelModelCountDTO> findActivePainelsByModel();
  ...
  List<PainelStateCountDTO> countPainelsByState();
  ...
  List<PainelInteractionCountDTO> findPainelsWithMostInteractions();
  ...
  List<PainelCityStatusCountDTO> countPainelsByCityAndStatus();
  ...
  List<PainelDTO> findPainelsWithAttentionAboveLevel(@Param("level") Byte level);
  ...
  List<PainelModelPeopleCountDTO> findModelsWithMostPeopleRegistered();
  ...
  List<PainelModelStateCountDTO> countPainelsByModelInState(@Param("state") String state);
  ...
  List<StateAverageInteractionsDTO> findAverageInteractionsByState();
