...
import propagandus.datalake.core.models.enumerators.ECityZoneType;
...
public record Location(
  ...
  @Column(length = 10, nullable = false, name = "city_zone") ECityZone cityZone,
  @Column(length = 10, nullable = false, name = "city_zone_type") ECityZoneType cityZoneType,
