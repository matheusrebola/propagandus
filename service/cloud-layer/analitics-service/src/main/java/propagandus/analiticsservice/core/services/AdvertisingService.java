...
public class AdvertisingService {
  ...
  public List<Advertising> findAdvertisingInLocationsWithMorePainels(int painelCount){return advertisingRepository.findAdvertisingInLocationsWithMorePainels(painelCount);}
}
